...
export default function LanguageSelector({ 
  ...
  const { currentLanguage, changeLanguage, getCurrentLanguageInfo, t } = useLanguage();
  ...
  const handleLanguageChange = (languageCode: SupportedLanguage) => {
    ...
    notification.className = 'fixed top-4 right-4 bg-green-100 border border-green-200 text-green-800 px-4 py-2 rounded-lg shadow-lg z-50 fade-in';
