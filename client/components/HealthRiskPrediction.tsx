...
export default function HealthRiskPrediction() {
  const [riskFactors, setRiskFactors] = useState<RiskFactor[]>([
    {
      ...
      recommendations: ['Continue regular monitoring', 'Maintain low-sodium diet', 'Regular exercise']
    },
    {
      id: 'cholesterol',
      ...
      recommendations: ['Increase fiber intake', 'Consider statin therapy', 'Regular lipid panel checks']
    },
    {
      id: 'exercise',
      ...
      recommendations: ['Maintain current routine', 'Add strength training', 'Track heart rate zones']
    },
    {
      id: 'sleep',
      name: 'Sleep Quality',
      ...
      recommendations: ['Consistent sleep schedule', 'Limit screen time before bed', 'Optimize sleep environment']
    },
    {
      id: 'stress',
      name: 'Stress Level',
      ...
      recommendations: ['Practice meditation', 'Consider stress management therapy', 'Regular relaxation techniques']
    },
    {
      id: 'family_history',
      ...
      recommendations: ['Enhanced screening', 'Genetic counseling', 'Proactive lifestyle modifications']
    }
  ]);
  ...
  const [healthRisks, setHealthRisks] = useState<HealthRisk[]>([
    {
      ...
      prevention: ['Regular cardio exercise', 'Mediterranean diet', 'Stress management'],
      icon: Heart,
      color: '#ef4444'
    },
    {
      ...
      prevention: ['Weight management', 'Regular glucose monitoring', 'Balanced nutrition'],
      icon: Activity,
      color: '#f59e0b'
    },
    {
      ...
      prevention: ['DASH diet', 'Regular BP monitoring', 'Medication compliance'],
      icon: TrendingUp,
      color: '#3b82f6'
    },
    {
      ...
      prevention: ['Therapy sessions', 'Social connections', 'Mindfulness practice'],
      icon: Brain,
      color: '#8b5cf6'
    }
  ]);
  ...
  const generateMLPredictions = () => {
    ...
    const timeframes = ['Current', '1 Week', '1 Month', '3 Months', '6 Months', '1 Year'];
    ...
    timeframes.forEach((timeframe, index) => {
      ...
      predictions.push({
        ...
        category: baseRisk < 20 ? 'Low Risk' : baseRisk < 50 ? 'Moderate Risk' : 'High Risk',
        prediction: generatePredictionText(baseRisk),
        confidence: 75 + Math.random() * 20,
        factors: ['Cardiovascular', 'Metabolic', 'Mental Health'].slice(0, Math.floor(Math.random() * 3) + 1)
      });
    });
  ...
  const runAIAnalysis = async () => {
    ...
    // Update risk factors with slight variations
    setRiskFactors(prev => prev.map(factor => ({
      ...factor,
      value: Math.max(0, Math.min(100, factor.value + (Math.random() - 0.5) * 10))
    })));
    
    // Update health risks
    setHealthRisks(prev => prev.map(risk => ({
      ...risk,
      probability: Math.max(0, Math.min(100, risk.probability + (Math.random() - 0.5) * 5)),
      confidence: Math.max(70, Math.min(95, risk.confidence + (Math.random() - 0.5) * 10))
    })));
  ...
  const overallRiskScore = Math.round(riskFactors.reduce((acc, factor) => {
    const weight = factor.impact === 'critical' ? 0.3 : factor.impact === 'high' ? 0.25 : factor.impact === 'medium' ? 0.15 : 0.1;
    ...
    <div className="space-y-6">
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-xl">AI Health Risk Prediction</CardTitle>
                <CardDescription>
                  Advanced machine learning analysis of your health trajectory
                </CardDescription>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg">
              <div className="text-4xl font-bold mb-2">
                <span className={getRiskColor(overallRiskScore)}>{overallRiskScore}</span>
              ...
              <div className="text-xs text-muted-foreground">
                Lower scores indicate better health outlook
              </div>
            </div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg">
              ...
              <div className="text-sm font-medium text-gray-600 mb-1">Last Analysis</div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg">
              ...
              <div className="text-xs text-muted-foreground">
                Based on 50,000+ health profiles
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-colored border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              Current health risk factors across different categories
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
        ...
        <Card className="shadow-colored border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              AI-predicted health risk progression over time
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
      ...
      <Card className="shadow-colored border-border/50">
        <CardHeader>
          ...
          <CardDescription>
            Individual analysis of factors contributing to your health risk profile
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {riskFactors.map((factor) => (
              <div key={factor.id} className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
      ...
      <Card className="shadow-colored border-border/50">
        <CardHeader>
          ...
          <CardDescription>
            Machine learning predictions for potential health conditions
          </CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{risk.timeframe} prediction</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span className={getRiskColor(risk.probability)}>{risk.probability}%</span>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span className="text-blue-600">{risk.confidence}%</span>
                      </div>
                      <Progress value={risk.confidence} className="h-2" />
                    </div>
                    
                    <div>
                      <div className="text-sm font-medium text-gray-700 mb-1">Primary Risk Factors:</div>
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-700 mb-1">Prevention Strategies:</div>
        ...
        <CardContent>
          <div className="space-y-4">
            <Alert className="border-blue-200 bg-blue-50">
              ...
              <AlertDescription>
                <strong>Key Insight:</strong> Your stress levels show an increasing trend that correlates with elevated cardiovascular risk. 
                Consider implementing stress reduction techniques and monitor heart rate variability.
              </AlertDescription>
            </Alert>
            ...
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertDescription>
                <strong>Positive Trend:</strong> Your physical activity levels are excellent and significantly reducing your risk for metabolic conditions. 
                Continue current exercise routine for optimal health benefits.
              </AlertDescription>
            </Alert>
            ...
            <Alert className="border-yellow-200 bg-yellow-50">
              ...
              <AlertDescription>
                <strong>Action Required:</strong> Sleep quality metrics suggest room for improvement. Poor sleep is linked to increased inflammation and cardiovascular risk. 
                Consider sleep hygiene optimization and possibly sleep study evaluation.
              </AlertDescription>
            </Alert>
          </div>
        </CardContent>
