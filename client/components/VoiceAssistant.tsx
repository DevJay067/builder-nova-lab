  ...
  const [messages, setMessages] = useState<VoiceMessage[]>([
    {
      ...
      type: "assistant",
      content:
        "Hello! I'm your AI health assistant. I can help you with medical questions, health tracking, and emergency guidance. How can I assist you today?",
      ...
      <CardContent className="space-y-4">
          ...
          !("SpeechRecognition" in window) && (
            <Alert className="border-yellow-200 bg-yellow-50">
              ...
              <AlertDescription>
                ...
                Chrome, Edge, or Safari for the full voice experience.
              </AlertDescription>
            </Alert>
          )}
        ...
        {voiceEnabled && synthesis && (
          <Alert className="border-green-200 bg-green-50">
            ...
            <AlertDescription>
              Voice assistant is ready! Click "Start Listening" and speak your
              health questions.
            </AlertDescription>
          </Alert>
        )}
