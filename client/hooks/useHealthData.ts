        ...
        const sampleInsights: HealthInsight[] = [
          {
            ...
            description:
              "Your heart rate variability has improved by 12% this week, indicating better cardiovascular fitness and stress management.",
            importance: "medium",
            action:
              "Continue current exercise routine and stress management practices",
          ...
          },
          {
            ...
            description:
              "Your deep sleep percentage has decreased from 22% to 16% over the past week. This may affect recovery and cognitive function.",
            importance: "high",
            action:
              "Improve sleep hygiene and consider reducing screen time before bed",
            category: "sleep",
            confidence: 92,
          },
          {
            ...
            description:
              "Your daily step count and activity duration remain consistent with your established patterns.",
            importance: "low",
