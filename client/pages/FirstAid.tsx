      ...
      // Fallback 3: Generated data near location (no network or APIs)
      {
        ...
        const hospitalData = baseHospitals
          .map((hospital, index) => {
            ...
            const effectiveRadiusKm = Math.max(searchRadius, 0.01);
            const baseMinDistanceKm = 0.01; // 10 meters
            const distance = baseMinDistanceKm + Math.random() * Math.max(effectiveRadiusKm - baseMinDistanceKm, 0);
